...
testsets= CustomDataset(test_set_mav, label_test_mav,test_set_var,test_set_wl)
...
# confusion_matrix
confusion_matrix_df = pd.DataFrame(confusion_matrix(label_test_mav, y_pred_list)).rename(columns=idx2class, index=idx2class)

sns.heatmap(confusion_matrix_df, annot=True)
print(classification_report(label_test_mav, y_pred_list))